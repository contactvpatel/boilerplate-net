...
public class StockRepositoryTests
{
    ...
    public StockRepositoryTests(TestDatabaseFixture fixture)
    {
        _fixture = fixture;
    ...
    [Fact]
    public async Task GetAllAsync_WhenCalled_ReturnsAllActiveStock()
    {
        await _fixture.ResetDatabaseAsync();
    ...
    [Fact]
    public async Task GetLowStockAsync_WhenCalled_ReturnsLowStockItems()
    {
        await _fixture.ResetDatabaseAsync();
