...
namespace WebShop.Business.Tests.Helpers;
...
public class BatchOperationHelperTests
{
    ...
    [Fact]
    public async Task ExecuteInTransactionAsync_OperationReceivesCancellationToken()
    {
        // Arrange
        Mock<IUnitOfWork> mockUnitOfWork = new();
    ...
    [Fact]
    public async Task ExecuteBatchAsync_OperationReceivesCancellationToken()
    {
        // Arrange
        Mock<IUnitOfWork> mockUnitOfWork = new();
        using CancellationTokenSource cts = new();
